...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="<?php echo base_url(); ?>/assets2/images/logo.png" type="image/x-icon">
    ...
    <link href="<?php echo base_url();?>/assets2/css/themes/theme-indigo.css" rel="stylesheet" />
</head>